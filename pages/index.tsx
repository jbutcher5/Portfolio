        ...
        <div className='flex flex-row items-center space-x-4'>
          <div className='ring-lime hover:ring top-1 rounded-full w-16 h-16'>
            <Link href={githubProfile} passHref>
              <Image className='fixed rounded-full cursor-pointer' alt={profileAlt} width='64' height='64' src={profilePicture} priority></Image>
            </Link>
          </div>
          <div>
            <div className='text-xl underline decoration-wavy font-medium text-black'>{GithubInfo["name"]}</div>
